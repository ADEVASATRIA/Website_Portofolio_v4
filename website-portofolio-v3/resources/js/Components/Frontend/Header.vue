...
<template>
        ...
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="https://flowbite.com/" class="flex items-center">
                <img src="https://user-images.githubusercontent.com/1915268/67271559-5ce2ee00-f4d8-11e9-81ce-faba29f09724.png" class="h-8 mr-3" alt="Laravel Logo" />
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Laravel Portofolio</span>
            </a>
